  ...
  const listContact = [
    {
      svg: (
        <svg
          ...
          className="w-5 h-5 dark:text-white text-green-400"
        >
    ...
    },
    {
      svg: (
        <svg
          ...
          width="1em"
          xmlns="http://www.w3.org/2000/svg"
          className="w-4 h-4 dark:text-white text-green-400"
        >
    ...
    <div className="flex items-center justify-between flex-wrap md:flex-nowrap dark:text-white text-green-400 px-4 bg-[#212529]">
      ...
      <div className="flex my-4 w-full md:w-auto justify-center md:justify-normal">
        {listContact.map((item, idx) => (
          <div
            key={idx}
            className="mr-4 rounded-full flex items-center justify-center cursor-pointer hover:animate-spin  transition-all duration-400"
          >
            {item.svg}
          </div>
        ))}
